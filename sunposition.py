...
def sunpos(dt, latitude, longitude, elevation=0, temperature=None, pressure=None, delta_t=0, radians=False):
...
def main(args):
    ...
    az, zen, ra, dec, h = sunpos(args.t, args.lat, args.lon, 0, 14.6, 1013.0, 0.0, False)
    if args.csv:
        #machine readable
